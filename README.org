...
- Get a copy of the Mercurial repository:  //**hg clone https://bitbucket.org/erlus/erlus **//
- Go into the downloaded directory: //**cd erlus**//
- Run rebar to get the dependencies: //**./rebar get-deps**//
- Run rebar to compile the erlang code into the ebin dir: //**./rebar compile**//
- Start the Erlus node: //**./scripts/start.sh**//
